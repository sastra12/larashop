...
@section('content')
    @includeIf('frontend.home.home_slider')
    <!--End hero slider-->

    @includeIf('frontend.home.home_features_category')
    <!--End category slider-->
    @includeIf('frontend.home.home_banner')
    <!--End banners-->

    @includeIf('frontend.home.home_new_product')
    <!--Products Tabs-->

    @includeIf('frontend.home.home_features_product')
    <!--End Best Sales-->
    ...
    <!--Vendor List -->
    @includeIf('frontend.home.home_vendor_list')
    <!--End Vendor List -->
@endsection
